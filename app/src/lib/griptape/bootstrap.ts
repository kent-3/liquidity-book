...
// import type { Coin, StdFee } from 'secretjs';
// import {
//   CosmWasmClient,
...
//   BroadcastMode,
// } from 'secretjs';
import { SecretNetworkClient, type BroadcastMode } from 'secretjs';
import {
...
async function initClient(): Promise<void> {
  ...
  client = new SecretNetworkClient({url: config.lcdUrl, chainId: config.chainId});
}
