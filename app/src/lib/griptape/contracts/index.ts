// This is a mess!! I don't want to reinvent griptape.js to be compatible with the current secret.js,
// but I'll leave this here in case I need to modify some parts of it.

import type { MsgExecuteContractResponse, BroadcastMode, TxResponse } from 'secretjs';
import {
  // queryContract,
  // executeContract,
  // getHeight,
...
import type { Coin } from 'secretjs';
