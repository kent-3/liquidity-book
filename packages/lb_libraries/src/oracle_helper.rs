...
// NOTE: Not sure if this will be useful. Leaving it here just in case.
//
// pub trait Oracle {
//     fn check_oracle_id(oracle_id: u16) -> Result<(), OracleError>;
//     fn get_sample(&self, oracle_id: u16) -> Result<OracleSample, OracleError>;
...
//         length: u16,
//     ) -> Result<(OracleSample, OracleSample), OracleError>;
//     fn set_sample(&mut self, oracle_id: u16, sample: OracleSample) -> Result<(), OracleError>;
//     fn update(
//         &mut self,
//         time: &Timestamp,
//         mut parameters: PairParameters,
