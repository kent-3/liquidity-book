...
pub struct InstantiateMsg {
    ...
    // TODO: I hate that all this staking stuff is baked into the pair contract
...
// TODO: where'd all these types come from? are we using all of them?
// I think they came from shade_protocol::contract_interfaces::swap... we should import them instead.

pub use shade_protocol::swap::{
    amm_pair::{CustomIterationControls, FeeInfo, StablePairInfoResponse, StableParams},
    core::{CustomFee, Fee, StableTokenData, StableTokenType, TokenPair},
};
